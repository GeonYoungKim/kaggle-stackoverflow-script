...
SELECT
    ...
    es_answer.owner_display_name as owner_display_name,
...
SELECT
    ...
    es_question.owner_display_name as owner_display_name,
...
SELECT
    ...
    es_comment.user_display_name as user_display_name,
